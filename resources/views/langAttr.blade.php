...
<div class="content-wrapper" ng-app="pns" ng-controller="langAttr" id="langAttr">
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <button class="btn btn-flat" style="width: 100%" ng-click="newAttribute()">Add</button>
              </div>
            </div>
            <br>
          </div>
  ...
  <script src="angular/langAttr_ctrl.js"></script>
</div>
<!-- /.content-wrapper -->
